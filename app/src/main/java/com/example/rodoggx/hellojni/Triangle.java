...
public class Triangle {
    ...
    //variable for triangle coordinates in ByteBuffer
    private FloatBuffer vertexBuffer;
    //variable for glprogram
    private final int glProgram;
    //variables to draw triangle
    ...
    float color[] = {1.0f, 0.54901960f, 0.0f, 1.0f};
    ...
    public Triangle() {
        ...
        int vertexShader = TriangleRenderer.loadShader(GLES20.GL_VERTEX_SHADER,
                vertexShaderCode);
        int fragmentShader = TriangleRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER,
                fragmentShaderCode);
